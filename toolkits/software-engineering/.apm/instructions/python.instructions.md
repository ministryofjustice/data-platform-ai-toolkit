...
- Avoid over-engineering: solve the problem in front of you, not speculative future ones.
...
- Load secrets from the environment or a secrets manager; never hard-code or commit them.
